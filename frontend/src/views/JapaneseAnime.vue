<template>
  <div class="japanese-anime-page">
    <!-- 页面标题 -->
    <div class="page-header">
      <h1 class="page-title">日本动漫</h1>
      <p class="page-subtitle">精选日本动漫作品</p>
    </div>
...
const fetchAnimeList = async (page = 1) => {
  try {
    ...
    console.log('📡 获取日本动漫列表:', { category: CATEGORY, page })
    ...
    if (response && response.code === 1) {
      ...
      console.log('📡 获取日本动漫数据成功，筛选后:', animeCount, '部动漫')
